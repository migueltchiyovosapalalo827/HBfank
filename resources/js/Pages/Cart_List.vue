                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center p-0 mt-3 mb-2">
                            <div class="px-0 pt-4 pb-0 mt-3 mb-3">
                                <div id="form">
                                    <ul id="progressbar">
                                        <li  v-for="(item, index) in stepList" :key="index" :class=" (current == index+1) ? 'active': '' ">
                                            <strong>{{item}}</strong>
                                        </li>
                                    </ul>
                                    <div class="progress">
                                    ...
                                    <h2>Sua lista de produtos</h2>
                                        <table class="table justify-content-center">
                                            ...
                                            <tbody>
                                                <tr v-for="cartItem in cartItems" :key="cartItem.id">
                                                    ...
                                                    <td>
                                                        <div class="col">
                                                            <img :src="`${cartItem.productoimagens[0].url}`"   :alt="`${cartItem.nome}`" width="80" height="80"
                                                    ...
                                                    <td>
                                                        <div class="col-md-3" style="margin: 0 auto;">
                                                            <input type="number" @click="addCartItem(cartItem)"
                                                                ...
                                                                min="1" v-model.number="cartItem.quantity">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="col-md-2" style="margin: 0 auto;">
                                                            <a href="#" @click="removeCartItem(cartItem)" class="btn btn-white border-secondary bg-danger btn-md my-2">
                                        ...
                                        <div class="col-md-4 d-flex justify-content-center align-items-center" style="color: #333; margin: 0 auto;">
                                            <h4>Total:</h4>
                                            <h1> &nbsp;Akz {{cartTotal}}</h1>
                                        </div>
                                    ...
                                    sair
                                        ...
                                        <button type="button" name="next-step" @click="nextStep()" class="next-step"> Avançar </button>
                                    </div>
                                    <div v-show="stepControle[1]">
                                            ...
                                            <div class="modal-content">
                                              <div class="modal-body p-4 text-center">
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="email" class="form-control rounded-4" id="floatingInput"  v-model="form.email" autofocus autocomplete="of">
                                                    <label style="color: #333;" for="floatingInput">Email</label>
                                                  </div>
                                                  <div class="form-floating mb-3">
                                                    <input type="password" class="form-control rounded-4" id="floatingPassword" v-model="form.password" required autocomplete="of">
                                                    <label style="color: #333;" for="floatingPassword">Password</label>
                                                  </div>
                                                   <div class="col-4">
                                                </div>
                                                  <small class="text-muted">Ainda não tem conta? </small><a href="#">Cadastre-se</a>
                                        ...
                                        <button type="button" name="previous-step"  @click="previousStep()" class="previous-step"> Voltar </button>
                                        </form>
                                    </div>
                                    <div v-show="stepControle[2]">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              <div class="modal-body p-4 text-center">
                                                <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" v-model="formaPagamento">
                                                  ...
                                                  <div class="input-group" v-if="formaPagamento != 'cash' ">
                                                    <input type="text" class="form-control" v-model="referencia_de_pagamento" placeholder="referencia de pagamento">
                                                    </div>
                                              </div>
                                            </div>
                                          </div>
  ...
  //send order to server with axios
    ...
    login() {
      ...
      this.nextStep();
            ...
            if (error.response) {this.setErrors(error.response.data.error);
              return false;
             }
        });
