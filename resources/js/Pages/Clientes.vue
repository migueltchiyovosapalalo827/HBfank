            ...
            <div class="modal-dialog" role="document">
                ...
                <form  @submit.prevent="editmode ? updateCliente() : createCliente()">
                   ...
                   <div class="form-group">
                            ...
                            <select name="bairro"  v-model="form.bairro" id="bairro" class="form-control" :class="{ 'is-invalid': form.errors.has('bairro') }">
                                <option v-for="bairro in bairros" :key="bairro.id" v-bind:value="bairro.id" :selected="form.bairros== bairro.id" >{{bairro.cidade.nome}}-{{bairro.nome}}</option>
