            ...
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="digite o nome do producto" id="kode-produk" v-model="search" @keyup="searchProduct()">
                        <div class="dropdown-search">
                            <ul>
                                <li v-for="data in productSearch" :key="data.id" @click="addProductToCart(data)"><img :src="`${data.productoimagens[0].url}`" alt="" class='dropdown-image'><span> {{ data.nome }}</span></li>
                            </ul>
                        </div>
                    </div>
                    <button type="button" class="btn btn-primary float-right" id="btn-tambah-produk">pesquisar</button>
        ...
        <div class="col-md-8">
            <div class="card m-b-30">
                <div class="card-body">
                 ...
                 {{successMsg.message}}  deseja imprimir a factura  <router-link :to="{ name:'/factura', params: {invoice_id: successMsg.data.id} }"><i class="nav-icon fas fa-print mr-1"></i> </router-link>
                    </div>
                    <div class="row mb-3">
                        <div class="col-8">
                    ...
                    <div class="float-right mb-2">
                        <h5>Total geral: <span id="rp">Akz <span id="total-price" data-value='0'>{{ formatPrice(totalPrice) }}</span></span></h5>
                    </div>
                    <form action="" method="post" id="form-transaction">
                            ...
                            <table class="table table-striped" id="table-transaction">
                                ...
                                <tbody>
                                    <tr v-for="(product,index) in cart" :key="product.id">
                                      ...
                                      <td>
                                        <input type="number" class="form-control" @blur="changeQuantity($event,index)" v-model.number="qty[index]" min="1">
                                        </td>
                        ...
                        <div>
                            ...
                            <button class="btn btn-primary float-right" type="button"  v-if="this.cart.length >= 1" @click="showKeteranganModal()">Processar a venda</button>
                        </div>
                    </form>
                </div>
            </div>
